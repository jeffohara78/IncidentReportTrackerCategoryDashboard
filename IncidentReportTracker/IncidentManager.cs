...
namespace IncidentReportTracker
{
    ...
    public class IncidentManager
    {
        ...
        public void AddIncident()
        {
            ...
            // Gets a standardized category value from a menu.
            string category = GetCategoryFromUser();

            // UPDATE MODIFIED 05/27/2026:
            // Constructor now includes category.
            IncidentReport newIncident = new IncidentReport(nextIncidentId, title, description, severity, category);
        ...
        public void SearchIncident()
        {
            ...
            foreach (IncidentReport incident in incidents)
            {
                ...
                // UPDATE ADDED 05/27/2026:
                // Category is checked safely because older JSON records may not have a category yet.
                bool categoryMatches = incident.Category != null && incident.Category.ToLower().Contains(searchTerm);

                // UPDATE MODIFIED 05/27/2026:
                // Search now includes category.
                if (titleMatches || descriptionMatches || severityMatches || categoryMatches)
                {
                    DisplayIncidentDetails(incident);
                    found = true;
                }
        ...
        // UPDATE ADDED 05/27/2026:
        // Allows the user to view only incidents from one category.
        public void FilterIncidentsByCategory()
        {
            ...
            if (!found)
            {
                Console.WriteLine($"No incidents found in category: {category}");
            }
        }
        ...
        // UPDATE ADDED 05/27/2026:
        // This helper method forces the user to select a valid incident category.
        // This improves data consistency and makes reporting/filtering more reliable.
        private string GetCategoryFromUser()
        {
            while (true)
            {
                ...
                Console.WriteLine("3. Unauthorized Access");
                Console.WriteLine("4. Data Leak");
                Console.WriteLine("5. Network Attack");
                Console.WriteLine("6. Insider Threat");
                Console.Write("Enter option 1 through 6: ");
                ...
                {
                    Console.WriteLine("Invalid category option. Please choose 1 through 6.");
                }
            }
        }
        ...
        private void DisplayIncidentDetails(IncidentReport incident)
        {
            ...
            // UPDATE ADDED 05/27/2026:
            Console.WriteLine($"Category: {incident.Category}");
        ...
        private void DisplayIncidentSummary()
        {
            ...
            foreach (IncidentReport incident in incidents)
            {
                ...
                // UPDATE MODIFIED 05/27/2026:
                // Added category to the shorter summary view.
                Console.WriteLine($"ID: {incident.IncidentId} | {incident.Title} | Category: {incident.Category} | Severity: {incident.Severity} | Status: {status}");
            }
        }
    }
}